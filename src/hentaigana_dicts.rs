...
fn get_hentaigana_group(romaji: &str) -> BTreeMap<String, String> {
    ...
    let brackets_left_dict: BTreeMap<&str, &str> = BTreeMap::from([
        ("1", "＜"),
        ("2", "『"),
        ("3", "【"),
        ("4", "“"),
    ...
    let brackets_right_dict: BTreeMap<&str, &str> = BTreeMap::from([
        ("1", "＞"),
        ("2", "』"),
        ("3", "】"),
        ("4", "”"),
    ...
    let quotes_dict: BTreeMap<&str, &str> = BTreeMap::from([
        ("1", "“"),
        ("2", "”"),
        ("3", "〝"),
        ("4", "〞"),
